                                    ...
                                    <tbody>
                                        @forelse($states as $key => $state)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $state->creator?->name ?? 'N/A' }}
                                                </td>
                                                <td>
                                                    {{ $state->created_at?->format('d M Y, h:i A') }}
                                                </td>
                                                <td>
                                                    {{ $state->updater?->name ?? 'N/A' }}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <form action="{{ route('states.destroy', $state->id) }}" method="POST"  onsubmit="return confirm('Are you sure you want to delete this state?')">
                                                                @csrf
                                                                @method('DELETE')
