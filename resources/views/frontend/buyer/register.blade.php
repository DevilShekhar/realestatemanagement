                ...
                <div class="col-lg-8 col-md-12">
                    <div class="seller-hero-content">
                        <div class="seller-hero-title">
                            ...
                            <span class="free-text">Buy With Confidence.</span>
                            <div class="seller-yellow-line"></div>
                        </div>
                        <div class="seller-hero-description">
                            <p>
                                Search properties in your preferred location and connect
                                directly with verified sellers and property owners.
                            </p>
                        </div>
                        <ul class="seller-benefits">
                            ...
                            <li>
                                <i class="fa fa-check"></i>
                                <span>
                                    Search properties by location, price and requirements
                                </span>
                            </li>
                            <li>
                                <i class="fa fa-check"></i>
                                <span>
                                    Direct WhatsApp &amp; call connect with property sellers
                                </span>
                            </li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="seller-hero-form-column">
                        <div class="seller-hero-card">
                            ...
                            <form action="{{ route('buyer.register.store') }}" method="POST" class="seller-hero-form">
                                @csrf                            
